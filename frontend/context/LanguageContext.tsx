...
const EN = {
  ...
  chatWithReport: "Chat with this Report",
  chatWithReportSub: "Ask follow-up questions — answered from the research",
  continueAsChain: "Continue as Research Chain",
  continueAsChainSub: "Auto-queue follow-up topics into a sequential series",
...
const ES: Translations = {
  ...
  chatWithReport: "Chatear con este informe",
  chatWithReportSub: "Haz preguntas de seguimiento — respondidas desde la investigación",
  continueAsChain: "Continuar como cadena de investigación",
  continueAsChainSub: "Encola automáticamente temas de seguimiento en una serie",
...
const FR: Translations = {
  ...
  chatWithReport: "Discuter avec ce rapport",
  chatWithReportSub: "Posez des questions de suivi — répondues à partir de la recherche",
  continueAsChain: "Continuer comme chaîne de recherche",
  continueAsChainSub: "File d'attente automatique de sujets de suivi en série",
...
const DE: Translations = {
  ...
  chatWithReport: "Mit diesem Bericht chatten",
  chatWithReportSub: "Stellen Sie Folgefragen — aus der Forschung beantwortet",
  continueAsChain: "Als Forschungskette fortsetzen",
  continueAsChainSub: "Folgethemen automatisch in eine Serie einreihen",
...
const HI: Translations = {
  ...
  chatWithReport: "इस रिपोर्ट से चैट करें",
  chatWithReportSub: "अनुवर्ती प्रश्न पूछें — शोध से उत्तर",
  continueAsChain: "शोध श्रृंखला के रूप में जारी रखें",
  continueAsChainSub: "अनुवर्ती विषयों को स्वतः एक श्रृंखला में जोड़ें",
